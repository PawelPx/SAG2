...
namespace SAG2.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    return RedirectToPage("/Swords/Index");
                }
        ...
        public async Task<IActionResult> OnPostSendVerificationEmailAsync()
        {
            ...
            if (user == null)
            {
                ModelState.AddModelError(string.Empty, "Verification email sent. Please check your account.");
            }
